...
func ChainStore(bs dtypes.ChainBlockstore, mbs dtypes.ChainRawBlockstore, ds dtypes.MetadataDS, syscalls vm.SyscallBuilder, j journal.Journal) *store.ChainStore {
	chain := store.NewChainStore(bs, mbs, ds, syscalls, j)
